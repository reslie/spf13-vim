...
```bash
    ...
    curl https://github.com/reslie/spf13-vim/raw/master/spf13-vim.sh -L > spf13-vim.sh && sh spf13-vim.sh
```

If you have a bash-compatible shell you can run the script directly:
```bash

    sh <(curl https://github.com/reslie/spf13-vim/raw/master/spf13-vim.sh -L)
```
